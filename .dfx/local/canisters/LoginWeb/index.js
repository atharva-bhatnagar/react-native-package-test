...
export const canisterId = process.env.CANISTER_ID_LOGINWEB;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./LoginWeb.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the LoginWeb canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./LoginWeb.did.js")._SERVICE>}
 */
